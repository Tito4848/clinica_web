...
<div class="container-fluid py-4">
        ...
        <div class="col-12">
            <div class="dashboard-card">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <a href="{{ route('doctor.horarios') }}" class="btn btn-success">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><strong>{{ $cita->nombre_paciente }}</strong></td>
                                <td>{{ $cita->telefono_paciente }}</td>
                                <td>
                                    @if($cita->comentarios)
                                        <small class="text-muted">{{ \Illuminate\Support\Str::limit($cita->comentarios, 50) }}</small>
                                    @else
    ...
    <div class="row">
        <div class="col-12">
            <div class="dashboard-card">
                <h4 class="text-dark mb-3">
                    <i class="bi bi-list-ul me-2"></i>Mis Citas
                </h4>
                <div class="citas-table">
                    <table class="table table-hover mb-0">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($cita->comentarios)
                                        <small class="text-muted" title="{{ $cita->comentarios }}">{{ \Illuminate\Support\Str::limit($cita->comentarios, 40) }}</small>
                                    @else
                                        <small class="text-muted">-</small>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        ...
                                        <form method="POST" action="{{ route('citas.destroy', $cita) }}" class="d-inline" onsubmit="return confirm('¿Estás seguro de eliminar esta cita?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-sm btn-danger" title="Eliminar cita">
