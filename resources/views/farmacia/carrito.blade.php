        ...
        <div class="row">
            <div class="col-md-8">
                <div class="cart-card mb-4">
                        ...
                        <tbody>
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('farmacia.carrito.update', $item) }}" class="d-inline">
                                            @csrf
                                            @method('PUT')
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('farmacia.carrito.destroy', $item) }}" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                    ...
                    <div class="mt-3">
                        <form method="POST" action="{{ route('farmacia.carrito.clear') }}">
                            @csrf
