...
<div class="container py-4">
            ...
            <div class="order-card">
                <div class="row align-items-center">
                    <div class="col-md-3">
                        ...
                        <small class="text-white-50">{{ $pedido->created_at->format('d/m/Y H:i') }}</small>
                    </div>
                    <div class="col-md-2">
                        <span class="badge 
                    ...
                    <div class="col-md-3">
                        <small class="text-white-50">{{ $pedido->detallePedidos->count() }} producto(s)</small>
                    </div>
    ...
    @else
        <div class="order-card text-center py-5">
            ...
            <h3 class="text-white mb-3">No tienes pedidos aún</h3>
            <p class="text-white-50 mb-4">Comienza a comprar en nuestra farmacia</p>
