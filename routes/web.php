...
Route::get('/profesionales', [ClinicaController::class, 'profesionales'])->name('profesionales');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/doctor/horarios', [DoctorDashboardController::class, 'horarios'])->name('doctor.horarios');
    Route::post('/doctor/horarios', [DoctorDashboardController::class, 'storeHorario'])->name('doctor.horarios.store');
    Route::delete('/doctor/horarios/{horario}', [DoctorDashboardController::class, 'destroyHorario'])->name('doctor.horarios.destroy');
    Route::patch('/doctor/horarios/{horario}/toggle', [DoctorDashboardController::class, 'toggleHorario'])->name('doctor.horarios.toggle');
});

// Citas
Route::post('/citas', [CitaController::class, 'store'])->name('citas.store');
Route::get('/citas/horarios-disponibles', [CitaController::class, 'getHorariosDisponibles'])->name('citas.horarios-disponibles');
Route::middleware('auth')->group(function () {
...
// Farmacia - Rutas específicas primero (antes de la ruta dinámica {slug})
Route::get('/farmacia', [FarmaciaController::class, 'index'])->name('farmacia.index');

// Carrito - Debe ir antes de /farmacia/{slug}
Route::get('/farmacia/carrito', [CarritoController::class, 'index'])->name('farmacia.carrito');
Route::post('/farmacia/carrito', [CarritoController::class, 'store'])->name('farmacia.carrito.store');
Route::put('/farmacia/carrito/{carrito}', [CarritoController::class, 'update'])->name('farmacia.carrito.update');
Route::delete('/farmacia/carrito/{carrito}', [CarritoController::class, 'destroy'])->name('farmacia.carrito.destroy');
Route::post('/farmacia/carrito/clear', [CarritoController::class, 'clear'])->name('farmacia.carrito.clear');

// Pedidos - Debe ir antes de /farmacia/{slug}
...
// Ruta dinámica de productos - Debe ir al final
